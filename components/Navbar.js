            ...
            <main className="w-full bg-crayola mx-auto p-6 rounded-b">
                <div className="flex items-center text-cultured justify-around">
                    ...
                    <section className="w-[30%] flex bg-transparent border-white border-[0.1px] rounded">
                        ...
                        }} className="px-4 py-2 w-full font-montserrat tracking-widest rounded placeholder:text-white outline-none text-[0.8rem] bg-transparent" type="text" placeholder="search movie .." value={searchValue} onChange={e => handleSearchValue(e.target.value)} />
